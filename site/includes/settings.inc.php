...
define('POMF_DB_PASS', 'changeme');

// Root location of files
define('POMF_FILES_ROOT', '/tmp/ipfsadd/');//I take great care of my user's data (but srs ipfs is managing that side)
...
define('POMF_URL', 'http://12.34.56.78/ipfs/');//deprecated
